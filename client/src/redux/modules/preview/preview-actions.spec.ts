...
import { ScaledContainerState } from 'containers/ScaledContainer/scaled.container';
import { DISTRIBUTIONS } from 'util/index';
import { SIDE, SYMBOLS } from 'util/BitMEX-types';

const distributionParams = (distribution: DISTRIBUTIONS, stop = '8000'): ScaledContainerState => {
  return {
    quantity: 500,
    n_tp: 3,
    start: 7500,
